        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl mb-6">
              Enterprise AI Innovation by <span className="text-blue-600 dark:text-blue-400">BizBot</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="p-6 text-center">
                <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">99.999%</div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="p-6 text-center">
              <Rocket className="h-12 w-12 text-blue-600 dark:text-blue-400 mx-auto mb-4" />
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <Card className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-lg text-blue-600 dark:text-blue-400 mb-4">Founder & Chief Architect</p>
            </div>
